...
| 竞品 | 排名 | 核心优势 | 核心弱点 | 应对策略 |
|------|------|----------|----------|----------|
| 清明上河园 | #1 | 全国知名度最高 | 7天环比-35%回落 | 抢占市场份额 |
| 万岁山武侠城 | #2 | 30天稳步增长+21% | 7天环比-43%大跌 | 持续关注 |
| 银基动物王国 | #3 | 30天环比+40%最快 | 7天环比仅+1% | 重点分析策略 |
| 只有河南 | #4 | 本地TGI 650极高 | 河南占比42%过高 | 差异化竞争 |
| 郑州方特 | #6 | 本地化严重 | 7天环比-52% | 已超越无需关注 |

**行业洞察**：7天环比普遍大幅下降（-35%~-52%），3月中旬整体热度回落，节后正常现象
"""
